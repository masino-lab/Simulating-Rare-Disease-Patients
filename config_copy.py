...
PROJECT_ROOT = Path(__file__).parent / "data_release"
...
# NB
STRONG_BETA_0 = 6.5910
STRONG_BETA_1 = -0.0252
STRONG_ALPHA = 0.2027
...
# poisson 
# NOISY_POS_PHEN_SAMPLES_LAMBDA = 700
# NOISY_NEG_PHEN_SAMPLES_LAMBDA = 570
